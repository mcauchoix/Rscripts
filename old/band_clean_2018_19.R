...
#---------------------------
b=read.csv('~/Dropbox/wild_cog_OF/banding/All_Banding_Tits_12042019.csv',sep=';',na.strings = c("NA","No Value","?","Undetermined","",'No','/'),dec=',',colClasses = "character")
b=b[,4:32]
# clean
...
# recapture
b$Recapture[b$Recapture %in% c('Recapture','Recap','recap','Yes')]='yes'
...
print("--------------------------")
#save in a file
write.table(b[bad_tag_ind,],paste('~/Dropbox/wild_cog_OF/banding/',"tag_errors.csv"),sep=";",row.names = F)
...
b$environement[b$Site %in% c('H4','H1','G1','CS','C4','Balacet')]="high"
