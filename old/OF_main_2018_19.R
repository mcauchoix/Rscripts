...
source('/Users/maximecauchoix/Downloads/Nice-R-Anova-Table-Export-master/Anova_table_export.R')
...
# OUT
pathD='/Users/maximecauchoix/IAST Dropbox/maxime cauchoix/wild_cog_OF/data/2018-2019/'
...
#dir.create(out_fit)
out_local='/Users/maximecauchoix/Documents/openfeeder/data/'

# IN
#experimental change# SAVE IN CSV
ec=read.xlsx('/Users/maximecauchoix/IAST Dropbox/maxime cauchoix/wild_cog_OF/logistique/OF timeline.xlsx',sheetName = 1,header = T)
ec=ec[,1:7]
...
source('~/IAST Dropbox/maxime cauchoix/wild_cog_OF/Rscripts/OF_summarise_banding.R')
...
# 8- Descriptive stat: By species 
#-------------------------------
source('~/IAST Dropbox/maxime cauchoix/wild_cog_OF/Rscripts/OF_descriptive_stats_bySpecies.R')

# 9- Individual data (nb trial, learning, TTC , ACC etc): DO DTC. 
#-------------------------------
source('~/IAST Dropbox/maxime cauchoix/wild_cog_OF/Rscripts/OF_individualStat_with learning.R')
...
#-------------------
source('~/IAST Dropbox/maxime cauchoix/wild_cog_OF/Rscripts/OF_participation.R')


# 11- Learning repeatability
#-------------------------------
source('~/IAST Dropbox/maxime cauchoix/wild_cog_OF/Rscripts/OF_repeatability.R')

# 10- Learning curves
#-------------------------------
source('~/IAST Dropbox/maxime cauchoix/wild_cog_OF/Rscripts/OF_learningCurves.R')
...
source('~/IAST Dropbox/maxime cauchoix/wild_cog_OF/Rscripts/OF_neophobia.R')
...
source('~/IAST Dropbox/maxime cauchoix/wild_cog_OF/Rscripts/OF_foraging.R')
